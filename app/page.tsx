...
export default function Home() {
  return(
    <div className="page-container bg-[url('/img/bg_main.png')] bg-cover bg-center">
      ...
      <video src="/img/window.mp4" autoPlay loop muted className="absolute top-79.5 left-1/2 transform -translate-x-1/2 object-cover scale-48" />
      ...
      <div 
        ...
        <Link 
          ...
          className="T1_20_DB px-4 py-3 border-3 border-green text-center bg-black block clip-corner-3">
            ENTER
        </Link>
      </div>
